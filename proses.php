...
// $db_0029 = new Database();

// $aksi = $_GET['aksi'];

// if ($aksi == 'tambah') {

//     $db_0029->tambahData($_POST['nama'], $_POST['jns_kelamin'], $_POST['alamat'], $_POST['nohp'], $_POST['gambar']);
//     header("location:index.php?status=success");

// } elseif ($aksi == 'update'){
//     $db_0029->updateData($_POST['id'], $_POST['nama'], $_POST['jns_kelamin'], $_POST['alamat'], $_POST['nohp'], $_POST['gambar']);
//     header("location:index.php");
    
// } elseif ($aksi == 'hapus'){
//     $db_0029->hapusData($_GET['id']);
//     header("location:index.php");
// }
...
if ($aksi == 'tambah') {
    ...
    if ($gambar) {
        ...
        $db_0029->tambahData($_POST['nama'], $_POST['jns_kelamin'], $_POST['alamat'], $_POST['no_hp'], $gambar);
        header("location:index.php?status=success");
        exit();
    } else {
...
elseif ($aksi == 'update') {
    ...
    if ($gambar) {
        ...
        $db_0029->updateData($_POST['id'], $_POST['nama'], $_POST['jns_kelamin'], $_POST['alamat'], $_POST['no_hp'], $gambar);
    } else {
        // Update data tanpa mengubah gambar (tidak diupload gambar baru)
        $db_0029->updateData($_POST['id'], $_POST['nama'], $_POST['jns_kelamin'], $_POST['alamat'], $_POST['no_hp'], null);
    }
    header("location:index.php?");
    exit();
}
